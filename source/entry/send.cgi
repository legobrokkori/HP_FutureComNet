...
#06.設置者のアドレス(カンマ区切り)
#$conf{'mailto'} = 't-hirai@f-cn.jp';
$conf{'mailto'} = 'k-watanabe@f-cn.jp';

#07.送信完了時にリダイレクトするサンクスページ
$conf{'thanks'} = 'http://www.f-cn.jp/recruit/thanks.html';

#08.設置者に届くメールの件名
$conf{'subject'} = '採用エントリー';

#09.送信者に届くメールの件名
$conf{'res_subject'} = '採用エントリーのお礼';

#10.送信者に届くメールの本文
$conf{'res_body'} = <<'__res_body_eof__';
この度は弊社の採用にエントリーして頂き誠にありがとうございました。
...
フューチャーコムネット　代表　平井　択弥

〒123-0872　東京都足立区江北2-7-11
TEL：03-5856-8677　FAX：03-5856-8679
VoIP：050-3691-7489
E‐mail： t-hirai@f-cn.jp
