...
if ($_SERVER["REQUEST_METHOD"] === "POST"){
	...
	if ($_POST['entryCategory'] === ""){
		$_POST['entryCategory'] = "3";
	}

	$_POST['entryMessagge'] = "アルバイト採用";
...
<meta name="description" content="FCN | FutureComnet | フューチャーコムネットのアルバイト採用エントリーページです。">
		...
		<div id="breadCrumbsArea">
			<div class="inner">
				<ul id="breadCrumbs">
					...
					<li><a href="http://www.f-cn.jp/recruit/recruit.html">採用情報</a></li>
					<li><a href="http://www.f-cn.jp/recruit/part.html">アルバイト採用</a></li>
					<li><strong>アルバイト採用｜応募フォーム</strong></li>
				</ul>
			</div>
		</div>
		<div id="rectuitContentsArticleArea" role="main">
			<div class="inner">
				<h1 id="contentsArticle">アルバイト採用<br><span id="en">part time jobs</span></h1>
			</div>
			<div id="backGroundPicturePar">
			</div>
		</div>
		<div class="inner">
			<div id="mainAreaEntryForm" role="main">
				<div class="jobContents">
					<h2 class="enrtyHeader">アルバイト応募フォーム</h2>
					<form id="entry" name="entryForm" method="post" action="<?php echo(filter_input(INPUT_SERVER, 'PHP_SELF',FILTER_SANITIZE_STRIPPED)); ?>">	
						...
						<div class="entryTableStyle">
							<dl>
								...
								<dd>
									<p>
										<input type="checkbox" class="validate[minCheckbox[1]]" name="occupation[]" value="通信機器系スタッフ">
										<label>通信機器系スタッフ</label>
									</p>
									<p>
										<input type="checkbox" class="validate[minCheckbox[1]]" name="occupation[]" value="イベントスタッフ">
										<label>イベントスタッフ</label>
									</p>
								</dd>
								<dt>氏名</dt>
								<dd>
