...
if ($_SERVER["REQUEST_METHOD"] === "POST"){
	...
	if ($_POST['entryCategory'] === ""){
		$_POST['entryCategory'] = "4";
	}

	$_POST['entryMessagge'] = "商品購入お問い合わせ";

	require_once '../../entry/InputCheck.php';
	require_once '../../entry/entryDivision/entryDivision.php';

	# 各画面毎の振る舞い　基底クラス
	$_POST['entryDivision'] = new Purchaser();
...
<meta name="description" content="FCN | FutureComnet | フューチャーコムネットの購入予定商品お問い合わせページです。">
<title>FCN|FutureComnet｜フューチャーコムネット</title>
				...
				<div id="siteNavListArea">
					<nav id="globalNav" role="navigation">
						<ul>
							...
							<li class="middleNav">
								<a id="nowRct" class="middleAnchor" href="//www.f-cn.jp/business/business.html">
							...
							<li class="middleNav">
								<a class="middleAnchor" href="//www.f-cn.jp/recruit/recruit.html">
		...
		<div id="breadCrumbsArea">
			<div class="inner">
				<ul id="breadCrumbs">
					...
					<li><a href="http://www.f-cn.jp/business/business.html">事業内容</a></li>
					<li><a href="http://www.f-cn.jp/business/detail/oa.html">OA機器 情報関連機器の販売・設置</a></li>
					<li><strong>ご購入の相談</strong></li>
				</ul>
			</div>
		</div>
		<div id="rectuitContentsArticleArea" role="main">
			<div class="inner">
				<h1 id="contentsArticle">ご購入の相談<br><span id="en">consultation of purchase</span></h1>
			</div>
			<div id="backGroundPictureContact">
			</div>
		</div>
		<div class="inner">
			<div id="mainAreaEntryForm" role="main">
				<div class="jobContents">
<!--					<h2 class="enrtyHeader">ご購入の相談</h2>-->
					<form id="entry" name="entryForm" method="post" action="<?php echo(filter_input(INPUT_SERVER, 'PHP_SELF',FILTER_SANITIZE_STRIPPED)); ?>">	
						...
						<div class="entryTableStyle">
							<dl>
								...
								<dd>
									<p>
										<input type="checkbox" class="validate[minCheckbox[1]]" name="products[]" value="＠TCOMヒカリ">
										<label>＠TCOMヒカリ</label>
									</p>
									<p>
										<input type="checkbox" class="validate[minCheckbox[1]]" name="products[]" value="＠nifty光">
										<label>＠nifty光</label>
									</p>
									<p>
										<input type="checkbox" class="validate[minCheckbox[1]]" name="products[]" value="iSmartひかり">
										<label>iSmartひかり</label>
									</p>
									<p>
										<input type="checkbox" class="validate[minCheckbox[1]]" name="products[]" value="U-mobile＊E">
										<label>U-mobile＊E</label>
									</p>
								</dd>
								<dt>氏名</dt>
								<dd>
								...
								<dd>
									<p>
										<input type="radio" name="creditcard" value="持っている" class="validate[required]" ><label>持っている</label>
										<input type="radio" name="creditcard" value="持っていない" class="validate[required]"  ><label>持っていない</label>
									</p>
									<p>
										<label><span class="descriptionFont">※ご契約者様は必ずクレジットカードが必要となります。</span></label>
									</p>
								</dd>
								<dt>ご希望連絡日時</dt>
								<dd>
								...
								<dd>
									<p>
										<input type="checkbox" name="hopemethod[]" value="電話" ><label>電話</label>
										<input type="checkbox" name="hopemethod[]" value="メール"  ><label>メール</label>
									</p>
								</dd>
							</dl>
						</div>
						...
						<div id="entryOrCancelButtonArea">
							<nav role="navigation">
								<ul>
									<li>
										<input id="entryButton" type="submit" value="お問い合わせ">
									</li>
									<li>
